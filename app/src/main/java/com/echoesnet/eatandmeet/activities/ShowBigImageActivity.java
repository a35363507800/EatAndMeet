...
import com.echoesnet.eatandmeet.utils.IMUtils.LoadLocalBigImgTask;
import com.echoesnet.eatandmeet.views.widgets.photoview.EasePhotoView;
...
public class ShowBigImageActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        image.setOnPhotoTapListener(new com.echoesnet.eatandmeet.views.widgets.photoview.PhotoViewAttacher.OnPhotoTapListener()
        {
            @Override
