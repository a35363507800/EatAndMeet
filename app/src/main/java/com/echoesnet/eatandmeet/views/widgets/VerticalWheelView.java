...
//    private ScrollView scrollView;
    ...
    public VerticalWheelView(Context context, AttributeSet attrs, int defStyle) {
...
//        views.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 236));
...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
                    if (remainder == 0) {
                        ...
                        if (remainder > itemHeight / 2) {
                            VerticalWheelView.this.post(new Runnable() {
                                @Override
                                public void run() {
                                    VerticalWheelView.this.smoothScrollTo(0, initialY - remainder + itemHeight);
                            ...
                            VerticalWheelView.this.post(new Runnable() {
                                @Override
                                public void run() {
                                    VerticalWheelView.this.smoothScrollTo(0, initialY - remainder);
                                    selectedIndex = divided + offset;
                                    onSeletedCallBack();
                                }
                            });
                    ...
                    initialY = getScrollY();
                    VerticalWheelView.this.postDelayed(scrollerTask, newCheck);
                }
            }
        };
...
//            paint.setColor(Color.parseColor("#00000000"));
    ...
    public void setSeletion(int position) {
        ...
        this.post(new Runnable() {
            @Override
            public void run() {
                VerticalWheelView.this.smoothScrollTo(0, p * itemHeight);
            }
        });
