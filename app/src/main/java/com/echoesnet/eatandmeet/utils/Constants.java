...
public class Constants {
    ...
    //正式
    public static int SDK_APPID = 1400015431;
    public static int ACCOUNT_TYPE = 7753;
    //测试
    /*public static final int SDK_APPID = 1400017380;
    public static final int ACCOUNT_TYPE = 8208;*/
    ...
    public static final int MSG_GIFT = 5;//自定义礼物消息
    public static final int MSG_PRAISE = 6;//自定义点赞消息
    ...
    public static final int AVIMCMD_Focus = AVIMCMD_ExitLive + 1;           // 点赞消息, Group消息  3(关注)
    ...
    public static final int AVIMCMD_Host_Close = AVIMCMD_Host_Back + 1;         // 主播关闭直播, Demo中使用Group消息 ： 6
    public static final int AVIMCMD_Host_ShutUp_off = AVIMCMD_Host_Close + 1;         // 主播禁言某人, Demo中使用Group消息 ： 7
    public static final int AVIMCMD_Host_ShutUp_on = AVIMCMD_Host_ShutUp_off + 1;         // 主播接触禁言某人, Demo中使用Group消息 ： 8
    public static final int AVIMCMD_FakeMember_Enter = AVIMCMD_Host_ShutUp_on + 1;         // 机器人用户加入, 中使用Group消息 ： 9
    public static final int AVIMCMD_FakeMember_Leave = AVIMCMD_FakeMember_Enter + 1;         // 机器人用户加入, 中使用Group消息 ： 10
    public static final int AVIMCMD_Member_Enter = AVIMCMD_FakeMember_Leave + 1;         // 真用户加入时，,主播同步聊天室消息给此人（单聊消息） 11
    public static final int AVIMCMD_Praise = AVIMCMD_Member_Enter + 1;         // 点赞 12
    public static final int AVIMCMD_Praise_Msg = AVIMCMD_Praise + 1;         // 点赞消息 13
    public static final int AVIMCMD_Booty_Call = AVIMCMD_Praise_Msg + 1;         // 约炮信息 14
    ...
    private static final String PACKAGE = "com.echoesnet.eatandmeet";
