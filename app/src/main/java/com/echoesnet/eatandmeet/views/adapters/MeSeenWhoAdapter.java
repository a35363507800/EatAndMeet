 ...
 */
public class MeSeenWhoAdapter extends BaseAdapter {
    private static final String TAG = MeSeenWhoAdapter.class.getSimpleName();
    // 填充数据的list
    ...
    // 构造器
    public MeSeenWhoAdapter(List<WhoSeenMeBean> list, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(TextUtils.isEmpty(bean.getRemark()))
        {
            ...
            holder.tv_info.setText("我查看了" + bean.getNicName() + "的个人信息");
        }else {
            holder.tv_title.setText(bean.getRemark());
            holder.tv_info.setText("我查看了" +bean.getRemark()+"的个人信息");
        }
