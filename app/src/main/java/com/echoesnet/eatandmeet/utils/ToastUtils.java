...
public class ToastUtils
{
    ...
    private static int yOffset = (int) (64 * EamApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    {
        LayoutInflater inflate = (LayoutInflater) EamApplication.getInstance().getApplicationContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
...
//    //使用
//    @Deprecated
//    public static void showShort(@Nullable Context context, @NonNull final CharSequence text)
//    {
//        showShort(text);
//    }
    ...
    {
        show(EamApplication.getInstance().getApplicationContext().getResources().getText(resId).toString(), duration);
    }
    ...
    {
        show(String.format(EamApplication.getInstance().getApplicationContext().getResources().getString(resId), args), duration);
    }
     ...
     * @param duration 显示时长
     */
    private static void show(@NonNull  CharSequence text, final int duration)
    {
        ...
        if (sViewWeakReference != null)
        {
            ...
            if (view != null)
            {
                sToast = new Toast(EamApplication.getInstance().getApplicationContext());
                sToast.setView(view);
        ...
        if (!isCustom)
        {
            if (messageColor != DEFAULT_COLOR)
            {
                ...
                sToast = Toast.makeText(EamApplication.getInstance().getApplicationContext(), spannableString, duration);
            }
            else
            {
                sToast = Toast.makeText(EamApplication.getInstance().getApplicationContext(), text, duration);
            }
        }
    ...
    public static void resetViewGravity()
    {
        ...
        yOffset = (int) (64 * EamApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().density + 0.5);
        xOffset = 0;
    }
