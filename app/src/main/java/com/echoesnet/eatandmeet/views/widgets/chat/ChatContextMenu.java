 ...
 * @Description This utility class can add a horizontal popup-menu easily
 * 该工具类可以很方便的为View、ListView/GridView绑定长按弹出横向气泡菜单
 * @link https://github.com/shangmingchao/PopupList
 */
public class ChatContextMenu
{
    ...
    public static final float DEFAULT_TEXT_SIZE_DP = 12;
    public static final float DEFAULT_TEXT_PADDING_LEFT_DP = 15.0f;
    public static final float DEFAULT_TEXT_PADDING_TOP_DP = 9.0f;
    public static final float DEFAULT_TEXT_PADDING_RIGHT_DP = 15.0f;
    public static final float DEFAULT_TEXT_PADDING_BOTTOM_DP = 9.0f;
     ...
     * {@link ChatContextMenu#showPopupListWindow(View, int, float, float, List, PopupListListener)}
        ...
        if (mPopupWindow == null || mPopupListListener instanceof AdapterPopupListListener)
        {
            ...
            for (int i = 0; i < mPopupItemList.size(); i++)
            {
                ...
                if (mPopupItemList.size() > 1 && i != mPopupItemList.size() - 1)
                {
                    ...
                    LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(mDividerWidth, ViewGroup.LayoutParams.MATCH_PARENT);
                    layoutParams.gravity = Gravity.CENTER;
            ...
            {
                if (mPopupListListener != null)
                    mPopupListListener.onPopupDismiss();
            });
        }
        if (mIndicatorView != null)
        {
    ...
    public void setMenuDissmissListener()
    {
    }
    ...
    public interface PopupListListener
    {
        ...
        /**
         * the popup dismiss can call this method
         */
        void onPopupDismiss();
