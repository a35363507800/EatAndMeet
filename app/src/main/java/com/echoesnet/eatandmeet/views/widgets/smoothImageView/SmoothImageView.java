package com.echoesnet.eatandmeet.views.widgets.smoothImageView;
...
public class SmoothImageView extends PhotoView
{
    ...
    private void initView()
    {
        ...
        mPaint = new Paint();
        mBgColor = ContextCompat.getColor(EamApplication.getInstance(), R.color.transparent);
        mPaint.setColor(mBgColor);
        mPaint.setStyle(Style.FILL);
        mOriginalLocationX = CommonUtils.getScreenWidth(null) / 2;
        mOriginalLocationY = CommonUtils.getScreenHeight1(null) / 2;
...
//      setBackgroundColor(mBgColor);
    ...
    private void initTransform()
    {
        ...
        Logger.t("smoothimage").d("xEScale=" + xEScale+"yEScale=" + yEScale );
        Logger.t("smoothimage").d("mBitmap.getHeight()=" + mBitmap.getHeight()+"mBitmap.getWidth()=" + mBitmap.getWidth() );
        ...
        Logger.t("SmoothImageViewTest").d("getWidth()=" + getWidth()+"bitmapEndWidth=" + bitmapEndWidth );
