 ...
 */
public class EamImageView extends ImageView
{
    ...
    public EamImageView(Context context) {
        super(context);
        init(context, null);
    }

    public EamImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EamImageView(Context context, AttributeSet attrs, int defStyleAttr) {
