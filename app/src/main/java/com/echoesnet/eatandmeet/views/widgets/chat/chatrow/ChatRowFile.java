...
public class ChatRowFile extends ChatRow
{
    ...
    public ChatRowFile(Context context, EMMessage message, int position, RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
...
//        adapter.notifyDataSetChanged();
    ...
    protected void onBubbleClick() {
        ...
        if (file.exists()) {
            ...
            // download the file
//            context.startActivity(new Intent(context, ShowNormalFileActivity.class).putExtra("msg", message));
        }
