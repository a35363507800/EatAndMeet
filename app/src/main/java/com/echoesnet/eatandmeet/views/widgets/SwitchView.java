...
public class SwitchView extends View {
    ...
    private boolean barrageFlag = false;
...
//		paint.setColor(isOn ? 0xff4bd763 : 0xffe3e3e3);
        paint.setColor(isOn ? 0xff9d45f9 : 0xffd2d2d2); // 滑动颜色
        canvas.drawPath(sPath, paint);  // 画底部
...
//        canvas.drawPath(bPath, paint); //修改
...
//		paint.setColor(isOn ? 0xff4ada60 : 0xffbfbfbf);
        paint.setColor(isOn ? 0xffbfbfbf : 0xffbfbfbf);
        canvas.drawPath(bPath, paint);

        if (barrageFlag) {
//            String text="弹";
//            float textWidth = paint.measureText(text, 0, text.length());
//            float textHeight = bRectF.height()*0.6f;
//            paint.setStyle(Style.FILL);
//            paint.setColor(Color.parseColor("#b717e5"));
//            paint.setTextSize(textHeight);
//
//            canvas.drawText(text, bRectF.width() / 2 - textWidth / 2, bRectF.height() / 2 + textHeight*0.5f , paint);


            canvas.drawBitmap(state==STATE_SWITCH_ON?((BitmapDrawable)(getResources().getDrawable(R.drawable.barrage_z1))).getBitmap()
                    :((BitmapDrawable)(getResources().getDrawable(R.drawable.barrage_z2))).getBitmap(),null,bRectF,null);
        }
