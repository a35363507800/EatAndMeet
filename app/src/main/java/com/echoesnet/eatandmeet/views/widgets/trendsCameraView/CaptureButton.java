...
import static com.echoesnet.eatandmeet.views.widgets.trendsCameraView.CameraView.BUTTON_STATE_BOTH;
import static com.echoesnet.eatandmeet.views.widgets.trendsCameraView.CameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.echoesnet.eatandmeet.views.widgets.trendsCameraView.CameraView.BUTTON_STATE_ONLY_RECORDER;
...
//    private boolean hasWindowFocus = true;
    ...
    public CaptureButton(Context context, int size) {
        ...
        button_outside_radius = button_radius * 0.85f;
        button_inside_radius = button_radius * 0.65f;
