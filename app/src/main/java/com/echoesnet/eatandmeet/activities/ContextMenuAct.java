...
public class ContextMenuAct extends BaseActivity
{
    /*public static final int RESULT_CODE_COPY = 1;
    public static final int RESULT_CODE_DELETE = 2;
    public static final int RESULT_CODE_FORWARD = 3;
    public static final int RESULT_CODE_CHANGE_VOICE_STYLE = 4;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        boolean isSpeakerOpen = getIntent().getBooleanExtra("voicePlayStyle", false);
        ...
        else if (type == EMMessage.Type.VOICE.ordinal())
        {
            ...
            TextView voiceStyle = (TextView) findViewById(R.id.tv_voice_play_style);
            if (isSpeakerOpen)
            {
                voiceStyle.setText("使用听筒模式");
            }
            else
            {
                voiceStyle.setText("使用扬声器模式");
            }
        }
    ...
    {
        setResult(RESULT_CODE_CHANGE_VOICE_STYLE);
        finish();
    }
