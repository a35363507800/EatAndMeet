...
//        mHighlightColor = 0xFFF74C39; // 指针、选中数字颜色
//        mHighlightColor = 0x00000000; // 原来设置为透明 不显示刻度
        mHighlightColor = 0xFF551797;
// 0xFF4CB4FB
//        mMarkTextColor = 0xFF666666; // 数字颜色
        mMarkTextColor = 0xFF333333;

//        mMarkColor = 0xFFEEEEEE; // 刻度颜色
        mMarkColor = 0x00000000;

        mCursorSize = density * 5;  // 指针
        mCenterTextSize = density * 12; // 数字
        mNormalTextSize = density * 12; // 数字单位
        mBottomSpace = density * 10;
...
//        mMarkTextPaint.setColor(0xFF4CB4FB); //选中数字的颜色
        mMarkTextPaint.setColor(0xFF551797);
    ...
    private void calcIntervalDis() {
        ...
        mIntervalDis = max * mIntervalFactor + 18; // +18 步长
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = start; i < end; i++) {
            ...
            if (mMarkCount > 0 && i >= 0 && i < mMarkCount) {
                ...
                if (mCenterIndex == i) {
//                    mMarkTextPaint.setColor(0xFF4CB4FB);
                    mMarkTextPaint.setColor(0xFF551797);  // 选中数字的颜色
                    mMarkTextPaint.setTextSize(mCenterTextSize);
                    if (!TextUtils.isEmpty(mAdditionCenterMark)) {
