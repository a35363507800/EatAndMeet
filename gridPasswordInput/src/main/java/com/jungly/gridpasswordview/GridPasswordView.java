...
public class GridPasswordView extends LinearLayout implements PasswordView
{
    ...
    private OnInputMethodViewChangeListener inputMethodViewChangeListener;
...
//            dividerView.setBackgroundDrawable(mLineDrawable);
            dividerView.setBackgroundColor(ContextCompat.getColor(mContext, R.color.C0323));
            dividerView.setTag("divider");
    ...
    private OnClickListener mOnClickListener = new OnClickListener()
    {
        ...
        public void onClick(View v)
        {
            ...
            else
            {
                ...
                setGridLineColor(R.color.C0323);
    ...
    private void forceInputViewGetFocus()
    {
        ...
        mInputView.setFocusableInTouchMode(true);
        mInputView.requestFocus();
        setGridLineColor(ContextCompat.getColor(mContext, R.color.C0311P));
        if (inputMethodViewChangeListener != null)
            inputMethodViewChangeListener.onInputMethodShow();
        InputMethodManager imm = (InputMethodManager) getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    public void setOnInputMethodViewChangeListener(OnInputMethodViewChangeListener listener)
    {
        inputMethodViewChangeListener = listener;
    }
    ...
    {
        mLineColor = color;
        super.setBackgroundDrawable(generateBackgroundDrawable());
        setShowDividers(SHOW_DIVIDER_NONE);
        setOrientation(HORIZONTAL);
        ...
        while (index < getChildCount())
        {
            ...
            if (tag != null && tag.equals("divider"))
            {
                getChildAt(index).setBackgroundDrawable(new ColorDrawable(mLineColor));
            }
            index++;
        }
    }

    public void setInputAbility(boolean isInput)
    {
        isAllowInput = isInput;
    }
    ...
    public interface OnInputMethodViewChangeListener
    {
