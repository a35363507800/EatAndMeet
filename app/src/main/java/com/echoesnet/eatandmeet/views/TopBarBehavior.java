 ...
 * @description
 */
public class TopBarBehavior extends CoordinatorLayout.Behavior<TopBarSwitch>
{
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, TopBarSwitch child, View dependency)
    {
        //依赖Toolbar控件
    ...
    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, TopBarSwitch child, View dependency)
    {
        // 初始化属性
     ...
     */
    private void shouldInitProperties(TopBarSwitch child, View dependency)
    {
