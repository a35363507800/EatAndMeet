...
import com.handmark.pulltorefresh.library.internal.EchoesLoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected LoadingLayout createDefaultLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		LoadingLayout layout = mLoadingAnimationStyle.createDefaulLoadingLayout(context, mode,
				getPullToRefreshScrollDirection(), attrs);
		layout.setVisibility(View.INVISIBLE);
		return layout;
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mFooterLayout = createDefaultLoadingLayout(context, Mode.PULL_FROM_END, a);
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				...
				case ECHOES:
					return new EchoesLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
		LoadingLayout createDefaulLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
					return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
