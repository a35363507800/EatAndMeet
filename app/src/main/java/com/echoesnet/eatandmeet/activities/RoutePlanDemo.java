...
import com.echoesnet.eatandmeet.views.widgets.baiduMap.overlayutil.BikingRouteOverlay;
import com.echoesnet.eatandmeet.views.widgets.baiduMap.overlayutil.DrivingRouteOverlay;
import com.echoesnet.eatandmeet.views.widgets.baiduMap.overlayutil.OverlayManager;
import com.echoesnet.eatandmeet.views.widgets.baiduMap.overlayutil.TransitRouteOverlay;
                                                                     ...
                                                                     OnGetRoutePlanResultListener
{
    ...
    public void changeRouteIcon(View v)
    {
        ...
        if (useDefaultIcon) {
            ...
            ToastUtils.showShort("将使用系统起终点图标");

        } else {
            ((Button) v).setText("系统起终点图标");
            ToastUtils.showShort("将使用自定义起终点图标");
