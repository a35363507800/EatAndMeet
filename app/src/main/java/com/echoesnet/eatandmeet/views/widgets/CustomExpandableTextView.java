...
public class CustomExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private static final String TAG = CustomExpandableTextView.class.getSimpleName();
    ...
    protected TextView mActionView; // Button to expand/collapse
    ...
    private CustomExpandableTextView.OnExpandStateChangeListener mListener;
    ...
    public void onClick(View view) {
        ...
        mActionView.setText(mCollapsed ? "全文" : "收起");
        ...
        Animation animation;
        if (mCollapsed) {
            animation = new CustomExpandableTextView.ExpandCollapseAnimation(this, getHeight(), mCollapsedHeight);
        } else {
            animation = new CustomExpandableTextView.ExpandCollapseAnimation(this, getHeight(), getHeight() +
    ...
    public void setOnExpandStateChangeListener(@Nullable CustomExpandableTextView.OnExpandStateChangeListener listener) {
        mListener = listener;
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        mAnimationDuration = typedArray.getInt(R.styleable.CusTomExpandableTextView_animDuration, DEFAULT_ANIM_DURATION);
        mAnimAlphaStart = typedArray.getFloat(R.styleable.CusTomExpandableTextView_animAlphaStart, DEFAULT_ANIM_ALPHA_START);
...
//        }
    ...
    private void findViews() {
        ...
        mActionView = (TextView) findViewById(R.id.expand_collapse);
        mActionView.setText(mCollapsed ? "全文" : "收起");
